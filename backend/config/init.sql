...
INSERT INTO packages (title, description, destination, price, duration_days, max_participants, image_url, rating, category, start_date, end_date, organizer_id, is_featured)
VALUES 
('Romántico Valle del Elqui', 'Escapada romántica con catas de vino y observación de estrellas en el Valle del Elqui.', 'Valle del Elqui', 600.00, 3, 8, 'https://images.unsplash.com/photo-1529921879218-08e7f1be8b9f', 4.7, 'romantic', '2025-10-10', '2025-10-12', 4, TRUE)
ON CONFLICT DO NOTHING;

INSERT INTO packages (title, description, destination, price, duration_days, max_participants, image_url, rating, category, start_date, end_date, organizer_id, is_featured)
VALUES 
('Cultural en Valparaíso', 'Tour cultural visitando murales, museos y arquitectura histórica en Valparaíso.', 'Valparaíso', 400.00, 2, 25, 'https://images.unsplash.com/photo-1505575967453-9a44a90b2b0c', 4.6, 'cultural', '2025-08-20', '2025-08-21', 4, FALSE)
ON CONFLICT DO NOTHING;
